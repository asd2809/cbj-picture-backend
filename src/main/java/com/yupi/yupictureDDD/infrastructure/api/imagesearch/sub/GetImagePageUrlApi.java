package com.yupi.yupictureDDD.infrastructure.api.imagesearch.sub;
...
public class GetImagePageUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=1";
