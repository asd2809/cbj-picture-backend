package com.yupi.yupictureDDD.domain.picture.service.impl;
...
import com.yupi.yupictureDDD.infrastructure.manager.upload.PictureUpload;
import com.yupi.yupictureDDD.infrastructure.manager.upload.PictureUploadTemplate;
import com.yupi.yupictureDDD.infrastructure.manager.upload.UrlPictureUpload;
import com.yupi.yupictureDDD.infrastructure.manager.upload.file.UploadPictureResult;
...
import com.yupi.yupictureDDD.domain.picture.service.PictureDomainService;
...
import com.yupi.yupictureDDD.infrastructure.utils.ColorSimilarUtils;
...
//        if(!userApplicationService.isAdmin(loginUser) ||!picture.getUserId().equals(loginUser.getId()) ){
//            ThrowUtils.throwIF(true,ErrorCode.PARAMS_ERROR);
//        }
...
//        }
    ...
    public void checkPictureAuth(User loginUser, Picture picture) {
        ...
        if(spaceId == null ){
            //此时操作的是公共图片
            if(!loginUser.isAdmin() && !loginUserId.equals(picture.getUserId())){
